...
COMPILER_CLEAN = lex.yy.c $(SRC).tab.c $(SRC).tab.h $(SRC).output $(SRC) *.?~ *.sa~ .make.out* *.asm Makefile~
...
# - u petlji će se kompajleru proslediti svi test*.sa fajlovi
...
help:
	...
	@echo -e "    \e[01;32mmake test TEST=test-ok1.sa\e[00m"
	@echo -e "    \e[01;32mmake det TEST=\"test-ok1.sa test-ok2.sa\"\e[00m"
